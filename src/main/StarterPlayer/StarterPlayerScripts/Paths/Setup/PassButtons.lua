...
local function LoadButton(Button)
    ...
    task.spawn(function()
        ...
        if Button.Name == "TycoonTeleport" then
            Button:WaitForChild("InfoPart").Info.Icon.Image = if Button:IsDescendantOf(Paths.Tycoon) then "rbxassetid://10234609500" else "rbxassetid://10236202746"
        end
